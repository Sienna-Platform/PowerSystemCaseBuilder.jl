const SYSTEM_CATALOG = [
    ...
    SystemDescriptor(;
        name = "pti_area_slack_variants_sys",
        description = "PSSE v33 case with area interchange slack-bus variants (valid, none, and nonexistent)",
        category = PSSEParsingTestSystems,
        raw_data = joinpath(DATA_DIR, "psse_raw", "area_slack_variants.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_v35_dgen_sys",
        description = "PSSE v35 case with load distributed generation (DGENP/DGENQ/DGENF) for netting tests",
        category = PSSEParsingTestSystems,
        raw_data = joinpath(DATA_DIR, "psse_raw", "psse_v35_dgen.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_v35_node_breaker_split_sys",
        description = "PSSE v35 case with a node-breaker substation split by an open switch",
        category = PSSEParsingTestSystems,
        raw_data = joinpath(DATA_DIR, "psse_raw", "psse_v35_node_breaker_split.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_v35_node_voltage_inherit_sys",
        description = "PSSE v35 case whose substation nodes store no voltage and inherit it from the bus",
        category = PSSEParsingTestSystems,
        raw_data = joinpath(DATA_DIR, "psse_raw", "psse_v35_node_voltage_inherit.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_v35_substation_sys",
        description = "PSSE v35 case with a populated node-breaker SUBSTATION section",
        category = PSSEParsingTestSystems,
        raw_data = joinpath(DATA_DIR, "psse_raw", "psse_v35_substation.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_v35_substation_records_sys",
        description = "PSSE v35 case with substation records carrying names, coordinates, and ground resistance",
        category = PSSEParsingTestSystems,
        raw_data = joinpath(DATA_DIR, "psse_raw", "psse_v35_substation_records.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
        name = "pti_v35_two_terminal_dc_sys",
        description = "PSSE v35 case with a two-terminal DC line for per-unit conversion tests",
        category = PSSEParsingTestSystems,
        raw_data = joinpath(DATA_DIR, "psse_raw", "psse_v35_two_terminal_dc.raw"),
        build_function = build_pti,
    ),
    SystemDescriptor(;
